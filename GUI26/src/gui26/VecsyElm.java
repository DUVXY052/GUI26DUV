...
public class VecsyElm extends JFrame {
    ...
    public void botonesActionPerformed(ActionEvent evt) {
        ...
        JOptionPane.showMessageDialog(null, "Has pulsado uno de los botones" + botonPulsado.getText());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VecsyElm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
